...
<jsp:useBean id="u" class="pojo.AddNewWaiterBean"/>   
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Waiter Tables</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <form action="addNewWaiter.jsp" method="post">
            <input type="submit" name="addwaiter" value="Add waiter">
            </form>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                   ...
                                   List<AddNewWaiterBean> list=DB.getWaiter(id);  
