...
<jsp:useBean id="u" class="pojo.AddNewCookBean"/>   
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cook Tables</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <form action="addNewCook.jsp" method="post">
            <input type="submit" name="addcook" value="Add Cook">
            </form>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                   ...
                                   List<AddNewCookBean> list=DB.getCook(id);  
