...
List<BranchBean> list=DB.getBranchDetailsName(branch_name);  
            request.setAttribute("list",list);
%>
                    <div class="panel-body">
                        <form action="addNewSubadminProcess.jsp" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="password" name="password" type="text" autofocus style="height:50px;" required>
                                </div>
                                
                                 <div class="form-group">
                                    <input class="form-control" placeholder="cpassword" name="cpassword" type="text" autofocus style="height:50px;" required>
                                </div>
                               
                                <c:forEach items="${list}" var="u">
                                    <div class="form-group">
                                        <input name="branch_id" type="hidden" value="<c:out value="${u.getId()}"/>" >
                                    </div>
                                 </c:forEach>
